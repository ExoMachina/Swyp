...
* Swyp is peer to peer
	* Swyp supports Wifi and Bluetooth pan (in supporting devices like iOS devices)
...
* Swyp uses public key encryption with user-generated certs to ensure transmitted data is opaque
...
* You may not use ExoMachina's "Swyp" trademark as the first word in a published application without ExoMachina's permission
	* Our intent is to reserve the trademark for developers of super-high quality apps, so if you're one, email 
